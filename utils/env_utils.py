...
def make_env_and_datasets(dataset_name, frame_stack=None):
    ...
    # env, train_dataset, val_dataset = ogbench.make_env_and_datasets(dataset_name, compact_dataset=True, env_only=True)
    env = ogbench.make_env_and_datasets(dataset_name, compact_dataset=True, env_only=True)
